...
BufferTF::BufferTF(ros::NodeHandle n, ros::NodeHandle priv_nh):
	...
	flag_callback(false)
{
	// laser_sub = n.subscribe("save_velodyne_1", 10, &BufferTF::laserCallback, this);
	laser_sub = n.subscribe("buffer5", 10, &BufferTF::laserCallback, this);
	
	buffer_pub = n.advertise<sensor_msgs::PointCloud2>("buffer_savepoint", 10);
